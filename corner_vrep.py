...
class cvBridgeDemo():
	...
	if (1.57 - self.angle) < 0.785:
		self.angle = 1.57 - self.angle
	else:
		pass

	self.angle2deg = math.degrees(self.angle)
	print("angle calc degrees", self.angle2deg)
	print("angle radians" , self.angle)
